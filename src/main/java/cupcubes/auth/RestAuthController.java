...
import cupcubes.auth.cache.AuthStateRedisCache;
import cupcubes.auth.custom.AuthMyGitlabRequest;
import cupcubes.auth.service.UserService;
...
//                        .redirectUri("http://localhost:9001/oauth/baidu/callback")
            ...
            case "google":
                authRequest = new AuthGoogleRequest(AuthConfig.builder()
                        .clientId("1058098210835-2hdddg1m95f0vrq0e1r07e5ia92gqhu1.apps.googleusercontent.com")
                        .clientSecret("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")
                        ...
                        .httpConfig(HttpConfig.builder()
                                .timeout(15000)
                                //配置你本地的代理端口
                                .proxy(new Proxy(Proxy.Type.HTTP, new InetSocketAddress("127.0.0.1", 12334)))
                                .build())
                        .build());
                break;
            case "facebook":
