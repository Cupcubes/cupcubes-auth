...
//    AMAZON("Amazon", "", "", "1.16.0", false),
//    DINGTALK_ACCOUNT("钉钉账号登录", "", "", "v1.16.0", false),
//    SLACK("slack 登录", "", "", "v1.16.0", false),
//    LINE("line 登录", "", "", "v1.16.0", false),
//    okta("Okta 登录", "", "", "v1.16.0", false),
//    proginn("程序员客栈", "", "", "v1.16.2", false),
    ;
